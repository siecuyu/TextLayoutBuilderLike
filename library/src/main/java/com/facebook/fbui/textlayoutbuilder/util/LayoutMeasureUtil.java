...
public class LayoutMeasureUtil {
   ...
   * or spacingadd) the StaticLayoutLike would erroneously add this space after the last line as well.
  ...
  public static int getHeight(Layout layout) {
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT_WATCH &&
            (layout instanceof StaticLayoutLike || layout instanceof StaticLayout)) {
