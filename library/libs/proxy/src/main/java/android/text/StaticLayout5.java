 ...
 */
public class StaticLayout5 extends Layout {

    static final String TAG = "StaticLayout5";

    public StaticLayout5(CharSequence source, TextPaint paint,
                        int width,
    ...
    public StaticLayout5(CharSequence source, int bufstart, int bufend,
    ...
    StaticLayout5(CharSequence text) {
...
//                                    whichPaint = mWorkPaint;
    ...
    // every time
    private static int[] nLineBreakOpportunities(String locale, char[] text, int length,
                                                        int[] recycle) {
        return NativeProxy.nLineBreakOpportunities(locale, text, length, recycle);
    }
