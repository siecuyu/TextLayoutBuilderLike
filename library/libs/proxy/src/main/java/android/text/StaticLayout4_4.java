...
public class StaticLayout4_4 extends Layout {

    static final String TAG = "StaticLayout4_4";

    public StaticLayout4_4(CharSequence source, TextPaint paint,
                        int width,
    ...
    public StaticLayout4_4(CharSequence source, int bufstart, int bufend,
...
//            e.mMethod = ellipsize;
            ...
            EllipsizerProxy.setmWidth(e, ellipsizedWidth);
            EllipsizerProxy.setmMethod(e, ellipsize);
        ...
        mLines = new int[ArrayUtilsProxy.idealIntArraySize(2 * mColumns)];
        mLineDirections = new Directions[
                ArrayUtilsProxy.idealIntArraySize(2 * mColumns)];
        mMaximumVisibleLineCount = maxLines;

        mMeasured = MeasuredTextLike.obtain();

        generate(source, bufstart, bufend, paint, outerwidth, textDir, spacingmult,
                 spacingadd, includepad, includepad, ellipsizedWidth,
                 ellipsize);

        mMeasured = MeasuredTextLike.recycle(mMeasured);
        mFontMetricsInt = null;
    }

    StaticLayout4_4(CharSequence text) {
        super(text, null, 0, null, 0, 0);

        mColumns = COLUMNS_ELLIPSIZE;
        mLines = new int[ArrayUtilsProxy.idealIntArraySize(2 * mColumns)];
        mLineDirections = new Directions[ArrayUtilsProxy.idealIntArraySize(2 * mColumns)];
    ...
    void generate(CharSequence source, int bufStart, int bufEnd,
        ...
        MeasuredTextLike measured = mMeasured;
        ...
        for (int paraStart = bufStart; paraStart <= bufEnd; paraStart = paraEnd) {
            ...
            if (spanned != null) {
                ...
                if (chooseHt.length != 0) {
                    if (chooseHtv == null ||
                        ...
                        chooseHtv = new int[ArrayUtilsProxy.idealIntArraySize(
                                            chooseHt.length)];
                    }
            ...
            for (int spanStart = paraStart, spanEnd; spanStart < paraEnd; spanStart = spanEnd) {
                ...
                if (spanned == null) {
                    ...
                    measured.addStyleRun4_4(paint, spanLen, fm);
                } else {
                    ...
                    measured.addStyleRun4_4(paint, spans, spanLen, fm);
                }
...
//                                    whichPaint = mWorkPaint;
                                    whichPaint = LayoutProxy.getmWorkPaint(this, paint);
                                }
    ...
    private int out(CharSequence text, int start, int end,
        ...
        if (want >= lines.length) {
            int nlen = ArrayUtilsProxy.idealIntArraySize(want + 1);
    ...
    private void calculateEllipsis(int lineStart, int lineEnd,
        ...
        float ellipsisWidth = paint.measureText(
                (where == TextUtils.TruncateAt.END_SMALL) ?
                        TextUtilsProxy.getELLIPSIS_TWO_DOTS() : TextUtilsProxy.getELLIPSIS_NORMAL(),
                0, 1);
        int ellipsisStart = 0;
        int ellipsisCount = 0;
     ...
     */
    private MeasuredTextLike mMeasured;
